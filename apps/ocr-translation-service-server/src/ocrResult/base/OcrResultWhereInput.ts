...
import { TranslationListRelationFilter } from "../../translation/base/TranslationListRelationFilter";

@InputType()
class OcrResultWhereInput {
  @ApiProperty({
    required: false,
  ...
  @ApiProperty({
    required: false,
    type: () => TranslationListRelationFilter,
  })
  @ValidateNested()
  @Type(() => TranslationListRelationFilter)
  @IsOptional()
  @Field(() => TranslationListRelationFilter, {
    nullable: true,
  })
  translations?: TranslationListRelationFilter;
}

export { OcrResultWhereInput as OcrResultWhereInput };
