...
export class TranslationResolverBase {
  ...
  async createTranslation(
    ...
    return await this.service.createTranslation({
      ...
      data: {
        ...
        ocrResult: args.data.ocrResult
          ? {
              connect: args.data.ocrResult,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => OcrResult, {
    nullable: true,
    name: "ocrResult",
  })
  async getOcrResult(
    @graphql.Parent() parent: Translation
  ): Promise<OcrResult | null> {
    const result = await this.service.getOcrResult(parent.id);
  ...
  @graphql.Mutation(() => TranslationCreateInput)
  async TranslateText(
    @graphql.Args()
    args: TranslationCreateInput
  ): Promise<TranslationCreateInput> {
    return this.service.TranslateText(args);
  }
}
