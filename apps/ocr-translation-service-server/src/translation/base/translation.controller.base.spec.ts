  ...
  test("POST /translations", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        translationTime: CREATE_RESULT.translationTime.toISOString(),
      ...
      .expect([
        {
          ...
          translationTime: FIND_MANY_RESULT[0].translationTime.toISOString(),
  ...
  test("GET /translations/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        translationTime: FIND_ONE_RESULT.translationTime.toISOString(),
